...
func TestCacheGetOrSet(t *testing.T) {
	...
	c := newCache()
	got, err := c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(keys []dskey.Key, set func(map[dskey.Key][]byte) error) error {
...
func TestCacheGetOrSetMissingKeys(t *testing.T) {
	...
	c := newCache()
	got, err := c.GetOrSet(context.Background(), []dskey.Key{myKey1, myKey2}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
...
func TestCacheGetOrSetNoSecondCall(t *testing.T) {
	myKey := dskey.MustKey("key/1/field")
	c := newCache()
	c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
		set(map[dskey.Key][]byte{myKey: []byte("value")})
		return nil
	})
	...
	got, err := c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
		called = true
		set(map[dskey.Key][]byte{myKey: []byte("value")})
		return nil
	})
...
func TestCacheGetOrSetErrorInTheMiddle(t *testing.T) {
	...
	myKey2 := dskey.MustKey("key/2/field")
	c := newCache()
	_, err := c.GetOrSet(context.Background(), []dskey.Key{myKey1, myKey2}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
		set(map[dskey.Key][]byte{myKey1: []byte("value")})
	...
	got, err := c.GetOrSet(context.Background(), []dskey.Key{myKey2}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
...
func TestCacheSetIfExist(t *testing.T) {
	...
	myKey2 := dskey.MustKey("key/2/field")
	c := newCache()
	c.GetOrSet(context.Background(), []dskey.Key{myKey1}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
	...
	// key2 should be.
	got, _ := c.GetOrSet(context.Background(), []dskey.Key{myKey1, myKey2}, func(keys []dskey.Key, set func(map[dskey.Key][]byte) error) error {
...
func TestCacheSetIfExistParallelToGetOrSet(t *testing.T) {
	...
	got, _ := c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
...
func TestGetWhileUpdate(t *testing.T) {
	...
	myKey1 := dskey.MustKey("key/1/field")
	myKey2 := dskey.MustKey("key/2/field")
	c.GetOrSet(context.Background(), []dskey.Key{myKey1, myKey2}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
	...
	for i := 0; i < count; i++ {
		go func(i int) {
			defer wg.Done()
			got[i], _ = c.GetOrSet(context.Background(), []dskey.Key{myKey1, myKey2}, func([]dskey.Key, func(map[dskey.Key][]byte) error) error { return nil })
		}(i)
	}
...
func TestCacheGetOrSetOldData(t *testing.T) {
	...
	<-waitForGetOrSetEnd
	data, err := c.GetOrSet(context.Background(), []dskey.Key{myKey1, myKey2}, func(keys []dskey.Key, set func(map[dskey.Key][]byte) error) error {
...
func TestCacheErrorOnFetching(t *testing.T) {
	...
	_, err := c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
		return rErr
	})
	...
	go func() {
		data, err := c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(key []dskey.Key, set func(map[dskey.Key][]byte) error) error {
			set(map[dskey.Key][]byte{myKey: []byte("value")})
			return nil
		})
		if err != nil {
...
func TestCacheConcurency(t *testing.T) {
	...
	for i := 0; i < count; i++ {
		...
		go func(i int) {
			...
			v, err := c.GetOrSet(context.Background(), []dskey.Key{myKey}, func(keys []dskey.Key, set func(map[dskey.Key][]byte) error) error {
