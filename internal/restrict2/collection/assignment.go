...
func (a Assignment) see(ctx context.Context, fetcher *dsfetch.Fetch, assignmentIDs []int) ([]attribute.Func, error) {
	return meetingPerm(ctx, fetcher, a, assignmentIDs, perm.AssignmentCanSee)
}
