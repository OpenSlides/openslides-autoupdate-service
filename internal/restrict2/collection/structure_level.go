...
func (s StructureLevel) see(ctx context.Context, fetcher *dsfetch.Fetch, structureLevelIDs []int) ([]attribute.Func, error) {
	return meetingPerm(ctx, fetcher, s, structureLevelIDs, perm.ListOfSpeakersCanSee, perm.UserCanSee)
}
