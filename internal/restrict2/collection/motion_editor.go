...
func (m MotionEditor) see(ctx context.Context, fetcher *dsfetch.Fetch, motionEditorIDs []int) ([]attribute.Func, error) {
	return meetingPerm(ctx, fetcher, m, motionEditorIDs, perm.MotionCanManageMetadata)
}
