...
var relationFields = map[string]string{
	...
	"mediafile/used_as_font_$_in_meeting_id":                           "meeting/font_$_id",
	"mediafile/used_as_logo_$_in_meeting_id":                           "meeting/logo_$_id",
	...
	"meeting/default_projector_$_id":                                   "projector/used_as_default_$_in_meeting_id",
	"meeting/font_$_id":                                                "mediafile/used_as_font_$_in_meeting_id",
	"meeting/list_of_speakers_countdown_id":                            "projector_countdown/used_as_list_of_speaker_countdown_meeting_id",
	"meeting/logo_$_id":                                                "mediafile/used_as_logo_$_in_meeting_id",
	...
	"projector/used_as_default_$_in_meeting_id":                        "meeting/default_projector_$_id",
	...
	"user/vote_delegated_$_to_id":                                      "user/vote_delegations_$_from_ids",
...
var relationListFields = map[string]string{
	...
	"user/assignment_candidate_$_ids":                          "assignment_candidate/user_id",
	"user/committee_ids":                                       "committee/user_ids",
	"user/group_$_ids":                                         "group/user_ids",
	"user/is_present_in_meeting_ids":                           "meeting/present_user_ids",
	"user/option_$_ids":                                        "option/content_object_id",
	"user/personal_note_$_ids":                                 "personal_note/user_id",
	"user/poll_voted_$_ids":                                    "poll/voted_ids",
	"user/projection_$_ids":                                    "projection/content_object_id",
	"user/speaker_$_ids":                                       "speaker/user_id",
	"user/submitted_motion_$_ids":                              "motion_submitter/user_id",
	"user/supported_motion_$_ids":                              "motion/supporter_ids",
	"user/vote_$_ids":                                          "vote/user_id",
	"user/vote_delegated_vote_$_ids":                           "vote/delegated_user_id",
	"user/vote_delegations_$_from_ids":                         "user/vote_delegated_$_to_id",
}
