...
var derivatePerms = map[TPermission][]TPermission{
	...
	"motion.can_manage":                  {"motion.can_create", "motion.can_create_amendments", "motion.can_manage_metadata", "motion.can_manage_polls", "motion.can_see", "motion.can_see", "motion.can_see", "motion.can_see", "motion.can_see", "motion.can_see_internal"},
	...
	"projector.can_see":                  {},
	"tag.can_manage":                     {},
	"user.can_manage":                    {"user.can_see", "user.can_see_extra_data"},
	"user.can_see":                       {},
