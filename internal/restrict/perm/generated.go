...
const (
	...
	UserCanSeePersonalData            TPermission = "user.can_see_personal_data"
...
var derivatePerms = map[TPermission][]TPermission{
	...
	"projector.can_see":                      {},
	"tag.can_manage":                         {},
	"user.can_manage":                        {"user.can_manage_presence", "user.can_see", "user.can_see", "user.can_see_personal_data", "user.can_update"},
	"user.can_manage_presence":               {"user.can_see"},
	"user.can_see":                           {},
	"user.can_see_personal_data":             {"user.can_see"},
	"user.can_update":                        {"user.can_see", "user.can_see_personal_data"},
}
