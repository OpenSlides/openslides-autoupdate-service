...
var collectionOrder = map[string]int{
	...
	"meeting/A":                        8,
	"meeting/E":                        9,
	"point_of_order_category":          10,
	"group":                            11,
	"projector":                        12,
	"projection":                       13,
	"projector_countdown":              14,
	"projector_message":                15,
	...
	"motion_block":                     21,
	"motion_category":                  22,
	"motion_change_recommendation":     23,
	"motion_comment_section":           24,
	"motion_comment":                   25,
	"motion_state":                     26,
	"motion_submitter":                 26,
	"motion_supporter":                 27,
	"motion_workflow":                  28,
	"poll":                             29,
	"poll_config_approval":             30,
	"poll_config_selection":            31,
	...
	"import_preview":                   47,
	"structure_level":                  48,
	"structure_level_list_of_speakers": 49,
	"motion_working_group_speaker":     50,
	"motion_editor":                    51,
	"gender":                           52,
	"history_entry":                    53,
	"history_position":                 54,
