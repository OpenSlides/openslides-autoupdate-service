...
var collectionOrder = map[string]int{
	...
	"motion_block":                     14,
	"motion_category":                  15,
	"motion_change_recommendation":     16,
	"motion_comment_section":           17,
	"motion_comment":                   18,
	"motion_state":                     19,
	"motion_statute_paragraph":         20,
	"motion_submitter":                 21,
	"motion_workflow":                  22,
	"poll":                             23,
	"option":                           24,
	"poll_candidate_list":              25,
	"poll_candidate":                   26,
	"vote":                             27,
	"organization":                     28,
	"organization_tag":                 29,
	...
	"projection":                       31,
	"projector":                        32,
	"projector_countdown":              33,
	"projector_message":                34,
	"theme":                            35,
	"topic":                            36,
	"list_of_speakers":                 37,
	"speaker":                          38,
	...
	"import_preview":                   42,
	"structure_level":                  43,
	"structure_level_list_of_speakers": 44,
	"motion_working_group_speaker":     45,
	"motion_editor":                    45,
}
