...
var collectionFields = map[string][]string{
	...
	"meeting_user":                 {"assignment_candidate_ids", "chat_message_ids", "comment", "id", "meeting_id", "number", "personal_note_ids", "projection_ids", "speaker_ids", "structure_level", "submitted_motion_ids", "supported_motion_ids", "user_id", "vote_delegated_to_id", "vote_delegated_vote_ids", "vote_delegations_from_ids", "vote_weight", "about_me"},
