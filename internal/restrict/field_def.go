...
var relationFields = map[string]string{
	...
	"projector/used_as_default_projector_for_agenda_item_in_meeting_id":              "meeting/default_projector_agenda_item_ids",
...
var relationListFields = map[string]string{
	...
	"meeting/default_projector_agenda_item_ids":                "projector/used_as_default_projector_for_agenda_item_in_meeting_id",
...
var restrictionModes = map[string]string{
	...
	"meeting/default_projector_agenda_item_ids":                  "B",
	...
	"projector/used_as_default_projector_for_agenda_item_in_meeting_id":              "A",
...
var collectionFields = map[string][]string{
	...
	"projector":                    {"aspect_ratio_denominator", "aspect_ratio_numerator", "background_color", "chyron_background_color", "chyron_font_color", "color", "current_projection_ids", "header_background_color", "header_font_color", "header_h1_color", "history_projection_ids", "id", "is_internal", "meeting_id", "name", "preview_projection_ids", "scale", "scroll", "sequential_number", "show_clock", "show_header_footer", "show_logo", "show_title", "used_as_default_projector_for_agenda_item_in_meeting_id", "used_as_default_projector_for_amendment_in_meeting_id", "used_as_default_projector_for_assignment_in_meeting_id", "used_as_default_projector_for_assignment_poll_in_meeting_id", "used_as_default_projector_for_countdown_in_meeting_id", "used_as_default_projector_for_current_list_of_speakers_in_meeting_id", "used_as_default_projector_for_list_of_speakers_in_meeting_id", "used_as_default_projector_for_mediafile_in_meeting_id", "used_as_default_projector_for_message_in_meeting_id", "used_as_default_projector_for_motion_block_in_meeting_id", "used_as_default_projector_for_motion_in_meeting_id", "used_as_default_projector_for_motion_poll_in_meeting_id", "used_as_default_projector_for_poll_in_meeting_id", "used_as_default_projector_for_topic_in_meeting_id", "used_as_reference_projector_meeting_id", "width"},
