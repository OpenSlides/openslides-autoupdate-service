...
var collectionFields = map[string][]string{
	...
	"motion":                       {"all_derived_motion_ids", "all_origin_ids", "derived_motion_ids", "forwarded", "id", "meeting_id", "number", "origin_id", "origin_meeting_id", "sequential_number", "start_line_number", "state_extension", "title", "agenda_item_id", "amendment_ids", "amendment_paragraph_$", "attachment_ids", "block_id", "category_id", "category_weight", "change_recommendation_ids", "comment_ids", "created", "last_modified", "lead_motion_id", "list_of_speakers_id", "modified_final_version", "option_ids", "personal_note_ids", "poll_ids", "projection_ids", "reason", "recommendation_extension", "recommendation_extension_reference_ids", "recommendation_id", "referenced_in_motion_recommendation_extension_ids", "referenced_in_motion_state_extension_ids", "sort_child_ids", "sort_parent_id", "sort_weight", "state_extension_reference_ids", "state_id", "statute_paragraph_id", "submitter_ids", "supporter_ids", "tag_ids", "text", "number_value"},
