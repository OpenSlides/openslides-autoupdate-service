...
var relationFields = map[string]string{
	...
	"meeting/default_projector_agenda_all_items_id":                     "projector/used_as_default_agenda_all_items_in_meeting_id",
	"meeting/default_projector_amendment_id":                            "projector/used_as_default_amendment_in_meeting_id",
	"meeting/default_projector_assignment_id":                           "projector/used_as_default_assignment_in_meeting_id",
	"meeting/default_projector_assignment_poll_id":                      "projector/used_as_default_assignment_poll_in_meeting_id",
	"meeting/default_projector_current_list_of_speakers_id":             "projector/used_as_default_current_list_of_speakers_in_meeting_id",
	"meeting/default_projector_list_of_speakers_id":                     "projector/used_as_default_list_of_speakers_in_meeting_id",
	"meeting/default_projector_mediafile_id":                            "projector/used_as_default_mediafile_in_meeting_id",
	"meeting/default_projector_motion_block_id":                         "projector/used_as_default_motion_block_in_meeting_id",
	"meeting/default_projector_motion_id":                               "projector/used_as_default_motion_in_meeting_id",
	"meeting/default_projector_motion_poll_id":                          "projector/used_as_default_motion_poll_in_meeting_id",
	"meeting/default_projector_poll_id":                                 "projector/used_as_default_poll_in_meeting_id",
	"meeting/default_projector_projector_countdowns_id":                 "projector/used_as_default_projector_countdowns_in_meeting_id",
	"meeting/default_projector_projector_message_id":                    "projector/used_as_default_projector_message_in_meeting_id",
	"meeting/default_projector_topics_id":                               "projector/used_as_default_topics_in_meeting_id",
	"meeting/default_projector_user_id":                                 "projector/used_as_default_user_in_meeting_id",
	...
	"motion_submitter/meeting_user_id":                                  "meeting_user/submitted_motion_ids",
	...
	"projector/used_as_default_agenda_all_items_in_meeting_id":          "meeting/default_projector_agenda_all_items_id",
	"projector/used_as_default_amendment_in_meeting_id":                 "meeting/default_projector_amendment_id",
	"projector/used_as_default_assignment_in_meeting_id":                "meeting/default_projector_assignment_id",
	"projector/used_as_default_assignment_poll_in_meeting_id":           "meeting/default_projector_assignment_poll_id",
	"projector/used_as_default_current_list_of_speakers_in_meeting_id":  "meeting/default_projector_current_list_of_speakers_id",
	"projector/used_as_default_list_of_speakers_in_meeting_id":          "meeting/default_projector_list_of_speakers_id",
	"projector/used_as_default_mediafile_in_meeting_id":                 "meeting/default_projector_mediafile_id",
	"projector/used_as_default_motion_block_in_meeting_id":              "meeting/default_projector_motion_block_id",
	"projector/used_as_default_motion_in_meeting_id":                    "meeting/default_projector_motion_id",
	"projector/used_as_default_motion_poll_in_meeting_id":               "meeting/default_projector_motion_poll_id",
	"projector/used_as_default_poll_in_meeting_id":                      "meeting/default_projector_poll_id",
	"projector/used_as_default_projector_countdowns_in_meeting_id":      "meeting/default_projector_projector_countdowns_id",
	"projector/used_as_default_projector_message_in_meeting_id":         "meeting/default_projector_projector_message_id",
	"projector/used_as_default_topics_in_meeting_id":                    "meeting/default_projector_topics_id",
	"projector/used_as_default_user_in_meeting_id":                      "meeting/default_projector_user_id",
	...
	"vote/delegated_user_id":                                            "meeting_user/vote_delegated_vote_ids",
...
var relationListFields = map[string]string{
	...
	"meeting_user/projection_ids":                              "projection/content_object_id",
	"meeting_user/speaker_ids":                                 "speaker/meeting_user_id",
	"meeting_user/submitted_motion_ids":                        "motion_submitter/meeting_user_id",
	"meeting_user/supported_motion_ids":                        "motion/supporter_ids",
	"meeting_user/vote_delegated_vote_ids":                     "vote/delegated_user_id",
	...
	"motion/supporter_ids":                                     "meeting_user/supported_motion_ids",
...
var genericRelationFields = map[string]map[string]string{
	...
	"option/content_object_id":           {"motion": "option_ids", "user": "option_ids"},
	...
	"projection/content_object_id":       {"agenda_item": "projection_ids", "assignment": "projection_ids", "list_of_speakers": "projection_ids", "mediafile": "projection_ids", "meeting": "projection_ids", "meeting_user": "projection_ids", "motion": "projection_ids", "motion_block": "projection_ids", "poll": "projection_ids", "projector_countdown": "projection_ids", "projector_message": "projection_ids", "topic": "projection_ids"},
}
...
var restrictionModes = map[string]string{
	...
	"meeting/default_projector_agenda_all_items_id":              "B",
	"meeting/default_projector_amendment_id":                     "B",
	"meeting/default_projector_assignment_id":                    "B",
	"meeting/default_projector_assignment_poll_id":               "B",
	"meeting/default_projector_current_list_of_speakers_id":      "B",
	"meeting/default_projector_list_of_speakers_id":              "B",
	"meeting/default_projector_mediafile_id":                     "B",
	"meeting/default_projector_motion_block_id":                  "B",
	"meeting/default_projector_motion_id":                        "B",
	"meeting/default_projector_motion_poll_id":                   "B",
	"meeting/default_projector_poll_id":                          "B",
	"meeting/default_projector_projector_countdowns_id":          "B",
	"meeting/default_projector_projector_message_id":             "B",
	"meeting/default_projector_topics_id":                        "B",
	"meeting/default_projector_user_id":                          "B",
	...
	"projector/used_as_default_agenda_all_items_in_meeting_id":         "A",
	"projector/used_as_default_amendment_in_meeting_id":                "A",
	"projector/used_as_default_assignment_in_meeting_id":               "A",
	"projector/used_as_default_assignment_poll_in_meeting_id":          "A",
	"projector/used_as_default_current_list_of_speakers_in_meeting_id": "A",
	"projector/used_as_default_list_of_speakers_in_meeting_id":         "A",
	"projector/used_as_default_mediafile_in_meeting_id":                "A",
	"projector/used_as_default_motion_block_in_meeting_id":             "A",
	"projector/used_as_default_motion_in_meeting_id":                   "A",
	"projector/used_as_default_motion_poll_in_meeting_id":              "A",
	"projector/used_as_default_poll_in_meeting_id":                     "A",
	"projector/used_as_default_projector_countdowns_in_meeting_id":     "A",
	"projector/used_as_default_projector_message_in_meeting_id":        "A",
	"projector/used_as_default_topics_in_meeting_id":                   "A",
	"projector/used_as_default_user_in_meeting_id":                     "A",
...
var collectionFields = map[string][]string{
	...
	"committee":                    {"default_meeting_id", "description", "id", "meeting_ids", "name", "organization_id", "organization_tag_ids", "user_ids", "forward_to_committee_ids", "forwarding_user_id", "manager_ids", "receive_forwardings_from_committee_ids"},
	"group":                        {"admin_group_for_meeting_id", "default_group_for_meeting_id", "id", "mediafile_access_group_ids", "mediafile_inherited_access_group_ids", "meeting_id", "meeting_user_ids", "name", "permissions", "poll_ids", "read_chat_group_ids", "read_comment_section_ids", "used_as_assignment_poll_default_id", "used_as_motion_poll_default_id", "used_as_poll_default_id", "weight", "write_chat_group_ids", "write_comment_section_ids"},
	...
	"projector":                    {"aspect_ratio_denominator", "aspect_ratio_numerator", "background_color", "chyron_background_color", "chyron_font_color", "color", "current_projection_ids", "header_background_color", "header_font_color", "header_h1_color", "history_projection_ids", "id", "meeting_id", "name", "preview_projection_ids", "scale", "scroll", "sequential_number", "show_clock", "show_header_footer", "show_logo", "show_title", "used_as_default_agenda_all_items_in_meeting_id", "used_as_default_amendment_in_meeting_id", "used_as_default_assignment_in_meeting_id", "used_as_default_assignment_poll_in_meeting_id", "used_as_default_current_list_of_speakers_in_meeting_id", "used_as_default_list_of_speakers_in_meeting_id", "used_as_default_mediafile_in_meeting_id", "used_as_default_motion_block_in_meeting_id", "used_as_default_motion_in_meeting_id", "used_as_default_motion_poll_in_meeting_id", "used_as_default_poll_in_meeting_id", "used_as_default_projector_countdowns_in_meeting_id", "used_as_default_projector_message_in_meeting_id", "used_as_default_topics_in_meeting_id", "used_as_default_user_in_meeting_id", "used_as_reference_projector_meeting_id", "width"},
	...
	"speaker":                      {"begin_time", "end_time", "id", "list_of_speakers_id", "meeting_id", "meeting_user_id", "note", "point_of_order", "speech_state", "weight"},
	...
	"user":                         {"default_number", "default_structure_level", "default_vote_weight", "first_name", "gender", "id", "is_demo_user", "is_physical_person", "is_present_in_meeting_ids", "last_login", "last_name", "meeting_user_ids", "option_ids", "poll_voted_ids", "pronoun", "title", "username", "vote_ids", "can_change_own_password", "is_active", "last_email_send", "committee_ids", "committee_management_ids", "email", "forwarding_committee_ids", "meeting_ids", "organization_management_level", "organization_id", "password", "default_password"},
