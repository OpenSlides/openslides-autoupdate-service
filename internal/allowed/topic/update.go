...
var updateFields = allowed.MakeSet([]string{
	"id",
	"title",
	"text",
	"attachment_ids",
...
func Update(ctx *allowed.IsAllowedContext) (bool, map[string]interface{}, error) {
	if err := allowed.ValidateFields(ctx.Data, updateFields); err != nil {
